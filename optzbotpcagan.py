...
def data():
    ...
    benign = np.loadtxt("UNSW_2018_IoT_Botnet_Original_10_best_Training.csv", delimiter = ",")
    benscan = np.loadtxt("UNSW_2018_IoT_Botnet_Original_10_best_Testing.csv", delimiter = ",")
...
fp = open('NEWBOT_IOT_Best_10_PCA_Mem_Train.log', 'w+')
...
train_runtime = print(end_train_time - start_train_time)

start_test_time = time.time()

precision = 10

fp = open('NEWBOT_IOT_Best_10_PCA_Mem_Test.log', 'w+')
...
loss_acc = print(result[0], result[1])

test_runtime = end_test_time = time.time()
